...
import string_ops
import desc_data_ops
import string_list_ops

OPERATORS_ID_FIELD: dict = {'equalTo': id_field_ops.equal_to, 'notEqualTo': id_field_ops.not_equal_to, "greaterThan": id_field_ops.greater_than, "lessThan": id_field_ops.less_than, "contains": id_field_ops.id_field_contains}
OPERATORS_ID_FIELD_LIST: dict = {'equalTo': id_field_list_ops.equal_to, "greaterThan": id_field_list_ops.greater_than, "lessThan": id_field_list_ops.less_than, "contains": id_field_list_ops.id_field_list_contains}
OPERATORS_DATE_FIELD: dict = {'equalTo': date_field_ops.equal_to, "greaterThan": date_field_ops.greater_than, "lessThan": date_field_ops.less_than}
OPERATORS_STRING_FIELD: dict = {'equalTo': string_ops.equal_to, 'contains': string_ops.contains }
OPERATORS_DICT_FIELD: dict = {'hasKey': desc_data_ops.hasKey, "contains": desc_data_ops.contains}
OPERATORS_STRING_FIELD_LIST: dict = {'contains': string_list_ops.contains, 'equalTo': string_list_ops.equal_to}
