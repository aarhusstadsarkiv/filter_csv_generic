...
def test_OPERATORS_ID_FIELD_contains(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "collection", "contains", "Sejrs Sedler"]
...
def test_OPERATORS_ID_FIELD_notEqualTo(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "collection", "notEqualTo", "2"]
...
def test_OPERATORS_ID_FIELD_equalTo(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "collection", "equalTo", "2"]
...
def test_OPERATORS_ID_FIELD_LIST_contains_two_filters(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "curators", "contains", "Test", "--filter", "curators", "equalTo", "1"]
...
def test_OPERATORS_DATE_FIELD_equalTo(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "date_from", "equalTo", "1877-04-17"]
...
def test_OPERATORS_DATE_FIELD_greaterThan(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "date_from", "greaterThan", "1877-04-17"]
...
def test_OPERATORS_DATE_FIELD_lessThan(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "date_from", "lessThan", "1877-04-17"]
...
def test_OPERATORS_STRING_FIELD_contains(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "desc_notes", "contains", "Tekstindholdet"]
...
def test_OPERATORS_STRING_FIELD_equalTo(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "desc_notes", "equalTo", "Tekstindholdet af dette kartotekskort er afskrevet af frivillige, men selve kortet er ikke digitaliseret."]
...
def test_OPERATORS_DICT_FIELD_contains(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "desc_data", "contains", "Typer:Farve"]
...
def test_OPERATORS_DICT_FIELD_hasKey(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "desc_data", "hasKey", "Typer"]
...
def test_OPERATORS_DICT_FIELD_contains_two_filters_w_datefield(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "desc_data", "contains", "Typer:Farve", "--filter", "date_from", "lessThan", "2000"]
...
def test_OPERATORS_STRING_FIELD_LIST_equalTo(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "barcode", "equalTo", "8025866751"]
...
def test_OPERATORS_STRING_FIELD_LIST_contains_on_two_barcodes(capfd):
    ...
    args = [csv_path, test_path_output, "--filter", "barcode", "contains", "80258", "--filter", "barcode", "contains", "11"]
